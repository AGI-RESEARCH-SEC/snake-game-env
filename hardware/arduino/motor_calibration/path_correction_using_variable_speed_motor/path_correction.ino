...
void right(int delay_parameter = 1000, bool move_forward=0) {
  Serial.println("Left");
...
void left(int delay_parameter = 1020, bool move_forward=0) {
...
//  // Move forward for 3 seconds
 forward();
 delay(1000);  // Sleep for 5 seconds
